<template>
  <div class="mark-container">
    <div v-if="mark && mark.url" class="area-icon">
      <img class="mark" :src="mark.url">
    </div>
    <div v-else class="area-icon">
      <img class="mark" src="@/assets/noimage-mark.png">
    </div>
    <div class="area-mark">{{mark.name}}</div>
...
.mark-container {
  ...
  grid-template-areas: "icon mark button";
